...
The estimated coefficients from the Negative Binomial regression model are summarized in **Table NB**.
...
To assess the model fit, we conducted a residual analysis by plotting the Pearson residuals against the fitted values  @ref(tab:residual-plot-1).

```{r residual-plot-2, fig.cap="Residuals vs. Fitted Values", echo=FALSE}
#| label: tab:residual-plot-1
# Plot residuals vs. fitted values
residuals <- residuals(nb_model, type = "pearson")
fitted_values <- fitted(nb_model)
